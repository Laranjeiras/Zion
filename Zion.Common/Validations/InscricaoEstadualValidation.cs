using System;
using Zion.Common.Enums;

namespace Zion.Common.Validations
{
    public class InscricaoEstadualValidation
    {
        public static bool IsValid(eUF uf, string inscr)
        {

            return IsValid(uf.ToString(), inscr);
        }

        private static bool IsValid(string pUF, string pInscr)
        {
            bool retorno = false;
            string strBase;
            string strBase2;
